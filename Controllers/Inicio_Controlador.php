		...
		return '
			<div id="alert-Actividades" class="flex p-4 mb-4 bg-blue-100 rounded-lg dark:bg-blue-200" role="alert">
				...
				<div class="ml-3 text-sm font-medium text-blue-700 dark:text-blue-800">
					Tienes Avances pendientes <a href="revisa_avances.php?type=actividades" class="justify-center w-full px-2 py-1.5 text-xs font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800"> Revisar </a>
				</div>
