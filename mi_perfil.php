            ...
            <div role="status" class="animate-pulse">
                ...
                <form action="models/mi_perfil_Model.php" method="POST">
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-3 group">
                            <input type="tel" name="telefono" id="" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="<?= $datos['tel'];?>" required />
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                        <div class="relative z-0 w-full mb-3 group">
                            <input type="text" name="nombre" id="" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="<?= $datos['nombre'];?> " required />
                        ...
                        <div class="relative z-0 w-full mb-3 group">
                            <input type="text" name="apellidos" id="" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="<?= $datos['apellidos'];?> " required />
