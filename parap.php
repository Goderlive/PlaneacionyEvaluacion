        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="models/mi_perfil_Model.php" method="POST" enctype="multipart/form-data">
                <div class="p-6 space-y-6">
                    ...
                    <div class="relative"> 
                        <input type="email" id="email" name="correo_electronico" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required/>
