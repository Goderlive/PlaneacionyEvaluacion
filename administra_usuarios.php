    ...
    <div class="container mx-auto">
        ...
        <?php if ($permisos['nivel'] == 4) : ?>
            <?php if ($cincos = buscacincos($con, $id_usuario)) : ?>
                <br> <br>
                <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700"></ul><br>
...
<?php if ($permisos['nivel'] == 1) : ?>
    <?php $usuarios = Traeadmins($con, $permisos['id_usuario']) ?>
        ...
        <li class="py-3 sm:py-4">
            <div class="flex items-center space-x-4">
                <div class="flex-1 min-w-0">
                    ...
                    <button data-modal-toggle="cambiarcontrasenia<?= $u['id_usuario'] ?>" class="my-3 mx-2 text-xs px-3 py-2 block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Cambiar Contraseña</button>
                    <form action="models/mi_perfil_Model.php" method="post">
                    ...
                    <br>
                    <!-- Aqui comienza el modal de contraseñas -->
                    <div id="cambiarcontrasenia<?= $u['id_usuario'] ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                        <div class="relative w-full h-full max-w-md md:h-auto">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="cambiarcontrasenia<?= $u['id_usuario'] ?>">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="sr-only">Cerrar modal</span>
