...
?>
    ...
    <body>
        ...
        <div class="container text-center mx-auto">
            ...
            <br>
            <h2 class="mx-3 text-2xl font-bold dark:text-white mr-auto">Logotipos en Formatos</h2>
            <br>
                    ...
                    <form action="" method="post">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th style="text-align: center;" class="px-6 py-3">
                                        Escudo Ayuntamiento
                                    </th>
                                    <th style="text-align: center;" class="px-6 py-3">
                                        Logo Administración
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td style="text-align: center;" class="px-6 py-4">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="path_logo_ayuntamiento">Seleccionar Escudo</label>
                                    <input id="path_logo_ayuntamiento" type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                </td>
                                <td style="text-align: center;" class="px-6 py-4">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="path_logo_administracion">Seleccionar Logo</label>
                                    <input id="path_logo_administracion" type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="text-align: center;">
                                    <br><button type="submit" name="logos" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
