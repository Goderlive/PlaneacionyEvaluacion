...
foreach($areas as $a){
    ...
    <table style="width:100%; padding: 2px;">
        <tr>
            ...
            <td style="width:10%; text-align: center; border:1px solid gray; font-size: 10px" rowspan="3">2024 </td>
        </tr>
    </table> &nbsp; <br> &nbsp;';
    ...
    <table style="width:100%;">
            <tr>
                <td style="width:40%;">
                    <table style="width:100%; padding: 2px;">
                        <tr>
                            <td style="width:50%; text-align: center; border:1px solid gray; font-size: 10px">ENTE PUBLICO: '.$ajustes['nombre_ente'].'</td>
                ...
                <td style="width:51%;">
                    <table style="width:100%; padding: 2px;">
                        <tr>
                            <td style="width:20%; text-align: right; font-size: 10px"></td>
                        ...
                        <tr>
                            <td style="width:20%; text-align: right; font-size: 10px">PROGRAMA</td>
                            <td style="width:20%; text-align: center; border:1px solid gray; font-size: 10px">'. $a['codigo_programa'] .'</td>
                            <td style="width:60%; text-align: left; border:1px solid gray; font-size: 10px">'. $a['nombre_programa'] .'</td>
                        </tr>
                        <tr>
                            <td style="width:20%; text-align: right; font-size: 10px">DEPENDENCIA GENERAL</td>
                            <td style="width:20%; text-align: center; border:1px solid gray; font-size: 10px">'. $a['clave_dependencia'] .'</td>
