    ...
    <table style="width:100%">
            <tr>
                <td style="width:30%">
                    <table style="width:100%">
                        <tr>
                            <td style="width:60%; text-align: center; border:1px solid gray; font-size: 8px">&nbsp; <br> ENTE PUBLICO: ///</td>
                            <td style="width:40%; text-align: center; border:1px solid gray; font-size: 8px">&nbsp;<br>No.: ///</td>
                        </tr>
                        <tr>
