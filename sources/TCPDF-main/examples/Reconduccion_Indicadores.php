	...
	<table style="width: 100%; padding: 2px;">
		...
		<tbody>
			<tr>
				...
				<td style="width: 9%; text-align: center; border: 1px solid black; border-collapse: collapse;">&nbsp;<br>&nbsp;<br>'.$reconduccion['avance_a'].'</td> 
			...
			<tr>
				...
				<td style="width: 9%; text-align: center; border: 1px solid black; border-collapse: collapse;">&nbsp;<br>&nbsp;<br>'.$reconduccion['avance_b'].'</td> 
